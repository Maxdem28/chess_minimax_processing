...
public class scacchiAlphaBeta extends PApplet {
...
public void draw() {
  ...
  if (gameAlive) {
    ...
    for (int i = 0; i < 8; i++) {
      for (int j = 0; j < 8; j++) {
        if (i%2==j%2) {
          ...
          rect(i*l, j*l, l, l);
          fill(255, 0, 0);
          if (scacchiera[j][i] == "P2") image(P2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "T2") image(T2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "C2") image(C2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "A2") image(A2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "K2") {
            image(K2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8); 
            vinceBianco = false;
          } else if (scacchiera[j][i] == "Q2") image(Q2, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "P1") image(P1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "T1") image(T1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "C1") image(C1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "A1") image(A1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
          else if (scacchiera[j][i] == "K1") {
            image(K1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8); 
            vinceNero = false;
          } else if (scacchiera[j][i] == "Q1") image(Q1, i*l+l*1.5f/8, j*l+l/8, l*5/8, l*6/8);
    ...
    if (vinceBianco) {
      ...
      grandTesto =70;
      textSize(grandTesto);
      text("WHITE WINS!", width/2-grandTesto*3.5f, height/2+grandTesto/3);
      gameAlive = false;
    } else if (vinceNero) {
      fill(255, 127, 80);
      grandTesto = 70;
      textSize(grandTesto);
      text("BLACK WINS!", width/2-grandTesto*3.5f, height/2+grandTesto/3);
      gameAlive = false;
    }
    if (flagLoading&&p==2) {
      fill(255, 0, 0);
...
public int maxi(int max, int min, int depth, String[][] scacchieraA) {
...
public int mini(int max, int min, int depth, String[][] scacchieraB) {
...
public void calcola(int depth, String[][] scacchieraC) {
...
public int evaluate(String[][] scacchieraD) {
  int ris = 0;
  for (int i = 0; i < 8; i++) {
    for (int j = 0; j < 8; j++) {
...
public boolean controllaT(int x, int y, int pX, int pY, String[][] scacchieraE) {
...
public boolean controllaT2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (x==pX) {
    if (y < pY) {
      for (int i = y+1; i < pY; i++) {
...
public boolean controllaC(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (abs(y-pY) == 2) {
    if (abs(x-pX) == 1) {
      if (scacchieraE[y][x].charAt(1)=='1') return false;
...
public boolean controllaC2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (abs(y-pY) == 2) {
    if (abs(x-pX) == 1) {
      if (scacchieraE[y][x].charAt(1)=='2') return false;
...
public boolean controllaA2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (pY-pX==y-x) {
    if (y > pY) {
      for (int i = y-1; i > pY; i--) {
...
public boolean controllaK2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
...
public boolean controllaQ2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (x==pX) {
    if (y < pY) {
      for (int i = y+1; i < pY; i++) {
...
public boolean controllaP2(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (x==pX) {
    if (y-pY==-2 && (pY == 6)) {
...
public boolean controllaA(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (pY-pX==y-x) {
    if (y > pY) {
      for (int i = y-1; i > pY; i--) {
...
public boolean controllaK(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (y==pY&&x==pX) return false;
  if (y-pY<=1&&y-pY>=-1&&x-pX<=1&&x-pX>=-1) {
...
public boolean controllaQ(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (x==pX) {
    if (y < pY) {
      for (int i = y+1; i < pY; i++) {
...
public boolean controllaP(int x, int y, int pX, int pY, String[][] scacchieraE) {
  if (x<0||x>7||y<0||y>7) return false;
  if (x==pX) {
    if (y-pY==2 && (pY == 1)) {
      if (scacchieraE[y][x] != "  ") return false;
...
public void mouseClicked() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "scacchiAlphaBeta" };
    if (passedArgs != null) {
